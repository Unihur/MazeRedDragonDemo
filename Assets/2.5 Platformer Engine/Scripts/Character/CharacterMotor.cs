...
namespace Platformer
{
    ...
    public class CharacterMotor : MonoBehaviour
    {
        ...
        private CharacterDirection _previousDirection = CharacterDirection.Right;
        ...
        private void applyMovement(float dt)
        {
            ...
            else
            {
                ...
                if (_isSliding)
                {
                    if (Direction == CharacterDirection.Right && _movement > 0.5f)
                        canMove = true;
                    else if (Direction == CharacterDirection.Left && _movement < -0.5f)
                        canMove = true;
                }
        ...
        private void applyTurn(float dt)
        {
            ...
            if (Mathf.Abs(delta) > 160)
                if ((Direction == CharacterDirection.Left && delta < 0) ||
                    (Direction == CharacterDirection.Right && delta > 0))
                    delta = -delta;
